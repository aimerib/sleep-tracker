defmodule SleepTracker.Pagination.HTML.SEO do
  @moduledoc """
  ...
  @defaults Keyword.drop(SleepTracker.Pagination.HTML.defaults(), [:view_style])
  ...
  def header_links(%SleepTracker.Pagination.Page{} = paginator),
    do: header_links(nil, paginator, [], [])

  def header_links(%SleepTracker.Pagination.Page{} = paginator, opts),
    do: header_links(nil, paginator, [], opts)

  def header_links(conn, %SleepTracker.Pagination.Page{} = paginator),
    do: header_links(conn, paginator, [], [])
  ...
  defp href(conn, paginator, args, opts, page_number) do
    ...
    path =
      opts[:path] || SleepTracker.Pagination.HTML.find_path_fn(conn && paginator.entries, args)
